                                ...
                                <div class="card" style="padding-right:10px;padding-left:10px;">
                                    <figure class="!rounded-[.4rem] !mb-6" style="height:250px; overflow:hidden; padding:0px">
                                        ...
                                        <a class="item-like opacity-0 absolute !w-[2.2rem] !h-[2.2rem] leading-[2.2rem] z-[1] transition-all duration-[0.3s] ease-in-out title_color shadow-[0_0.25rem_0.75rem_rgba(30,34,40,0.02)] text-[1rem] flex items-center justify-center rounded-[100%] right-0 bg-[#ffffff] top-4 group-hover:opacity-100 group-hover:right-4"
                                            ...
                                            <i data-id="<?php echo e($product->id); ?>" class="uil uil-heart before:content-['\eb66']"></i>
                                        </a>
                                    ...
                                    <div class="post-header" style="height:100px; overflow:hidden; padding:0px">
                                        ...
                                        <h2 class="post-title h3 text-[1.1rem]">
                                            <a href="<?php echo e(route('front.product.view', $product->slug)); ?>" class="title_color"><?php echo e($product->title); ?></a>
                                        </h2>
                                    </div>
                                    <p class="price !m-0">
                                        <ins class="no-underline"><span class="amount"><?php echo e(number_format($product->price, 0, '.', ',')); ?> đ</span></ins>
                                    </p>
                                </div>
                            </div>
...
<?php echo $__env->make('frontend_tp.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BOOTWINDOW10\Desktop\Mobile\Plant-shop\backend\resources\views/frontend_tp/product/category.blade.php ENDPATH**/ ?>